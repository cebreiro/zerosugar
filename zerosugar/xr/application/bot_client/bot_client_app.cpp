...
namespace zerosugar::xr
{
    ...
    {
        ZEROSUGAR_LOG_INFO(GetServiceLocator(), fmt::format("[{}] initialize bot control service", GetName()));
        ...
        ZEROSUGAR_LOG_INFO(GetServiceLocator(), fmt::format("[{}] initialize bot control service --> Done", GetName()));
    }
}
